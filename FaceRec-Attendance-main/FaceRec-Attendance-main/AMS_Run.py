    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/K.SANJEEV.KUMAR/Desktop/clgminpro1/FaceRec-Attendance-main/FaceRec-Attendance-main/Attendance/Manually Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select, "C:/Users/K.SANJEEV.KUMAR/Desktop/clgminpro1/FaceRec-Attendance-main/FaceRec-Attendance-main/Attendance/Manually Attendance"')
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='AliceBlue')
                cs = 'C:/Users/K.SANJEEV.KUMAR/Desktop/clgminpro1/FaceRec-Attendance-main/FaceRec-Attendance-main' + fileName
    ...
    def log_in():
        ...
        if username == 'test':
            if password == '1234':
                ...
                cs = 'C:/Users/K.SANJEEV.KUMAR/Desktop/clgminpro1/FaceRec-Attendance-main/FaceRec-Attendance-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
